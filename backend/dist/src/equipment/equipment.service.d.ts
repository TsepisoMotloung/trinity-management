...
export declare class EquipmentService {
    ...
    createCategory(dto: CreateEquipmentCategoryDto, userId: string, ipAddress?: string): Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        name: string;
    ...
    updateCategory(id: string, dto: UpdateEquipmentCategoryDto, userId: string, ipAddress?: string): Promise<{
        id: string;
        createdAt: Date;
        updatedAt: Date;
        name: string;
    ...
    deleteCategory(id: string, userId: string, ipAddress?: string): Promise<{
        message: string;
    }>;
    createItem(dto: CreateEquipmentItemDto, userId: string, ipAddress?: string): Promise<{
        category: {
            id: string;
            createdAt: Date;
            updatedAt: Date;
    ...
    updateItem(id: string, dto: UpdateEquipmentItemDto, userId: string, ipAddress?: string): Promise<{
        category: {
            id: string;
            createdAt: Date;
            updatedAt: Date;
    ...
    updateItemStatus(id: string, dto: UpdateEquipmentStatusDto, userId: string, ipAddress?: string): Promise<{
        category: {
            id: string;
            createdAt: Date;
            updatedAt: Date;
    ...
    deleteItem(id: string, userId: string, ipAddress?: string): Promise<{
        message: string;
    }>;
    checkAvailability(equipmentIds: string[], startDate: Date, endDate: Date, excludeEventId?: string): Promise<{
        available: string[];
        unavailable: {
            id: string;
            name: string;
