...
export declare class TransactionsController {
    ...
    checkOut(dto: CreateCheckOutDto, userId: string): Promise<{
        event: {
            id: string;
            name: string;
        };
    ...
    checkIn(dto: CreateCheckInDto, userId: string): Promise<{
        event: {
            id: string;
            name: string;
        };
    ...
    getEquipmentHistory(equipmentId: string, skip?: string, take?: string): Promise<{
        equipmentItem: {
            category: {
                id: string;
                createdAt: Date;
